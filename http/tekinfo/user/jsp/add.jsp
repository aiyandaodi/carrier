...
-->
<html xmlns="http://www.w3.org/1999/xhtml"><!-- #BeginTemplate "/Templates/add.dwt.jsp" --><!-- DW6 -->
<head>
...
<!-- #BeginEditable "head" -->
<!-- 自己的head -->
<meta name="keywords" content="user,new,create,right,用户,新建,创建" />
<meta name="description" content="user,new,create,right,用户,新建,创建" />
<link href="../../../common/tek/css/add.css" rel="stylesheet" type="text/css" media="screen" />
<script>
  $(document).ready(function() {
    initWaiting(null, 80, 80);
	checkMenu();
  });
</script>
<title>User 系统用户 - 新建</title>
<!-- #EndEditable -->
</head>
...
<!-- #BeginEditable "init" -->
<!-- 初始化信息，包含objectId、upload、remoting等 -->
<%
	remoting = new UserRm();
...
<!-- #BeginEditable "panel" -->
<!-- 输入框 -->
        <form action="addCheck.jsp" id="addForm" name="addForm" method="post" accept-charset="<%= charset %>"<%= upload ? "enctype='multipart/form-data'" : ""%>>
<%
