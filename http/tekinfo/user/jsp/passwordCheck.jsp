...
<!-- 调用Rm修改信息的方法 -->
<%
				result = ((UserRm) remoting).setPassword(token.getTokenCode(), clientIp, parameters.getParameters(fields));
%>
<!-- #EndEditable -->
...
<%
		...
		if (userId != 0 && userId == my.getId()) {
			String pwd = parameters.getParameter(UserOp.FIELD_NEW);
