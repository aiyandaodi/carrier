...
%>
        ...
        <div class="loginItem">
          <div id="btnIcon"></div>
            <button type="button" id="logoutBtn" name="logoutBtn" onclick="logout('<%= request.getContextPath() %>/servlet/login');">注销</button>
        </div>
      </form>
    </div>
  <!-- end #logout --></div>
...
%>
        ...
        <div class="loginItem">
          <div id="pswdIcon"></div>
          <input id="password" name="password" class="inputBox" type="password" size="15"  value="" onfocus="javascript:this.select();" onkeypress="pressKeyLogin(event, '<%= request.getContextPath()%>/servlet/login');"/>
        </div>
        <div class="loginItem">
          <input value="0" id="autoLogin" name="autoLogin" class="checkbox" type="checkbox"/><label for="autoLogin">自动登录</label>
          <!-- 忘记密码 -->
        </div>
        <div class="loginItem">
          <div id="btnIcon"></div>
	      <button id="loginBtn" name="loginBtn" type="button" onclick="login('<%= request.getContextPath()%>/servlet/login');"></button>
        </div> 
        <div class="loginItem">
        </div> 
      </form>
