...
<!-- #BeginEditable "head" -->
<!-- 自己的head -->
<meta name="keywords" content="user,edit,write,right,用户,修改,编辑" />
<meta name="description" content="user,edit,write,right,用户,修改,编辑" />
...
<!-- #BeginEditable "panel" -->
<!-- 输入框 -->
        <form action="editCheck.jsp" id="editForm" name="editForm" method="post" accept-charset="<%= charset %>"<%= upload ? "enctype='multipart/form-data'" : ""%>>
<%
