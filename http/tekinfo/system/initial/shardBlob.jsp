      ...
      <div class="col-md-12">
        ...
        <div class="widget worange" id="login_div">
          ...
          <div class="widget-head">
            <i class="icon-lock"></i> 文档BLOB拆分到单独表中
          </div><!-- end .widget-head -->
...
<%
	...
	if (transfer) {
		...
		Result result = remoting.shardBlob(token.getTokenCode(), clientIp, parameters.getParameters());
		if (result != null) {
			out.println("转换完成!<br/>");
...
%>
    <form action="" id="transferForm" name="transferForm" method="post">
      ...
      <div id="waiting" class="center" style="display:none;">正在拆分...</div>
      <div class="center">
        <input id="transferButton" name="transferButton" type="button" onclick="transferBlob()" value="开始拆分"/>
      </div>
    </form>
			</div><!-- end .padd -->
...
<script type="text/javascript" language="javascript">
  ...
  function transferBlob() {
	var flag = window.confirm("是否拆分Blob?");
    if (!flag)
      return ;
