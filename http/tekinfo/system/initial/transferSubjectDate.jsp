...
<%@ page import="com.takall.remoting.subject.SubjectTransferRm" %>
      ...
      <div class="col-md-12">
        ...
        <div class="widget worange" id="login_div">
          ...
          <div class="widget-head">
            <i class="icon-lock"></i> 主题subject_date字段由VARCHAR(10)转换为BIGINT
          </div><!-- end .widget-head -->
...
<%
	...
	if (transfer) {
		SubjectTransferRm remoting = new SubjectTransferRm();
		Result result = remoting.transferSubjectDate(token.getTokenCode(), clientIp, parameters.getParameters());
		if (result != null) {
			out.println("转换完成!<br/>");
