...
{ 
  window.open("read.html?answer_id="+id+"&show-close=1&refresh-opener=1");
}
			
//编辑用户
function editInfo(id)
{ 
  window.open("edit.html?answer_id="+id+"&show-close=1&refresh-opener=1");
} 
