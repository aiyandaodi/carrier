...
// 跳转到ipass登录页面
function iLogin() {
	var msg = "<img src='" + tek.common.getRootPath() + "http/images/waiting-small.gif' width='16'/>  正在跳转到登录页面，请稍后...";
...
// 跳转到ipass注册页面
function iRegister() {
	var msg = "<img src='" + tek.common.getRootPath() + "http/images/waiting-small.gif' width='16'/>  正在跳转到注册页面，请稍后...";
	tek.macCommon.waitDialogShow(null, msg, null, 2);
