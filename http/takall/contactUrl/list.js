...
// 删除信息
function removeThisInfo(contact_url_id, contact_url_name){
    var params = {};
    params["objectName"] = "ContactUrl";
    params["action"] = "removeInfo";
    params["contact_url_id"] = contact_url_id;

    tek.macList.removeInfo(contact_url_id, contact_url_name, params);
}