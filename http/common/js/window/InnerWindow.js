...
function InnerWindow(name, parent) {
  ...
  html+="<tr>";
  html+="<td id='"+this.getMinmizeId()+"'><img width='21px' height='19px' src='"+minOutIcon+"' alt='最小化' onmouseover='javascript:this.src=\""+minOverIcon+"\";' onmouseout='javascript:this.src=\""+minOutIcon+"\";' onclick='getInnerWindow(\""+name+"\").setMinmize();' style='martin-right:5px;'/></td>";
  html+="<td id='"+this.getResizeId()+"' style='display:none;'><img width='21px' height='19px' src='"+resizeOutIcon+"' alt='还原' onmouseover='javascript:this.src=\""+resizeOverIcon+"\";' onmouseout='javascript:this.src=\""+resizeOutIcon+"\";' onclick='getInnerWindow(\""+name+"\").setResize();'></td>";
  html+="<td id='"+this.getMaximizeId()+"'><img width='21px' height='19px' src='"+maxOutIcon+"' alt='最大化' onmouseover='javascript:this.src=\""+maxOverIcon+"\";' onmouseout='javascript:this.src=\""+maxOutIcon+"\";' onclick='getInnerWindow(\""+name+"\").setMaximize();'></td>";
  html+="<td id='"+this.getCloseId()+"'><img width='21px' height='19px' src='"+closeOutIcon+"'alt='关闭' onmouseover='javascript:this.src=\""+closeOverIcon+"\";' onmouseout='javascript:this.src=\""+closeOutIcon+"\";' onclick='getInnerWindow(\""+name+"\").close();'></td>";
  html+="</tr>";
  html+="</table>";
  html+="</li>";
  // 内容
