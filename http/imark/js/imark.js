...
// 跳转到登录界面
function goLogin() {
  tek.common.callPage(tek.common.getRootPath()+"http/imark/login/index.html", location.href);
}

// 跳转到注销页面
function goLogout() {
  tek.common.callPage(tek.common.getRootPath()+"http/imark/login/logout.html", location.href);
}

// 跳转到注册页面
function goRegister() {
  tek.common.callPage(tek.common.getRootPath()+"http/imark/login/register.html", location.href);
}

function clientService(){
	var url=tek.common.getRootPath()+"http/imark/audit/control.html";
	//alert("url="+url);
...
function goTakallService(){
	...
	var callBackUrl=tek.common.getRootPath()+"http/imark/audit/control.html";
