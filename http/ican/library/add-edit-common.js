...
function showProTag(id, name, type, isChecked) {
	...
	var html = "<li>"
		+ "<input name='exams_library_tags' type='checkbox' id='tag_" + id + "' value='" + tek.dataUtility.stringToHTML(name)
	...
	var setting = {
		callback: {
			success: function (nodes) {
				//显示主题目录树
				showLibraryCatalog(nodes, libraryCatalog);
			},
			error: function (errorMsg) {
...
//显示主题目录树
function showLibraryCatalog(nodes, libraryCatalog) {
